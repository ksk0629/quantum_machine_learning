...
class XAngle(BaseParametrisedLayer):
    """X angle encoder class"""

    def __init__(self, data_dimension: int, name: str = "XAngle"):
    ...
    def _build(self) -> None:
        ...
        for qubit in range(self.num_state_qubits):
            ...
            parameter = qiskit.circuit.Parameter(
                self._get_parameter_name(f"XAngle[{parameter_index_str}]")
            )
